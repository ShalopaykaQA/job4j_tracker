        ...
        while (run) {
            ...
            if (select == 0) {
                ...
                if (tracker.replace(id, editedItem)) {
                    ...
                    System.out.println("Item with Id " + id + " was not edited");
                }
            } else if (select == 3) {
                ...
                if (tracker.delete(id)) {
                    ...
                    System.out.println("Item with Id " + id + " was not removed");
                }
            } else if (select == 4) {
                ...
                if (item != null) {
                    ...
                    System.out.println("Item with " + id + " was not found");
                }
            } else if (select == 5) {
                ...
                if (items.length > 0) {
                    ...
                    System.out.println("No items with " + name + "were found");
                }
            } else if (select == 6) {
                run = false;
            }
